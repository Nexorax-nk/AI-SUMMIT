...
export default function HeroButtons() {
  return (
    ...
    >
      ...
      <button className="group flex items-center justify-center gap-3 px-8 py-3.5 rounded-full border border-white/20 hover:border-white/40 hover:bg-white/5 transition-all duration-300 w-full sm:w-auto">
